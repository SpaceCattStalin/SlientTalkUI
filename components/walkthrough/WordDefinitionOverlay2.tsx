...
const WordDefinitionVideoOverlay = ({
    next,
    step: { mask },
    ...
    return (
        ...
        >
            ...
            <View style={styles.overlay}>
                <Text style={styles.title}>Mô hình 3D giúp bạn học</Text>

                <Text style={styles.subtitle}>
                    Hãy quan sát mô hình 3D để học nhanh hơn!
                </Text>
                <Pressable
...
export default WordDefinitionVideoOverlay;
