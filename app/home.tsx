...
import { IOverlayComponentProps, useWalkthroughStep, WalkthroughProvider } from 'react-native-interactive-walkthrough';
...
const Home = () => {
    ...
    // const WrappedWelcomeOverlay = (props: IOverlayComponentProps) => (
    //     <Provider store={store}>
    //         <WelcomeMessageOverlay {...props} />
    //     </Provider>
    // );
    ...
    const { onLayout: step4OnLayout, stop, goTo } = useWalkthroughStep({
        number: 4,
        fullScreen: false,
